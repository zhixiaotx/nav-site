...
1. 点击左侧 **分类栏** 挑选感兴趣的分类
2. 在右侧查看该分类下的「站点名称 · 链接 · 介绍」表格
3. 用顶部 **搜索框** 直接搜「分类名 / 站点名」
...
| | | |
| --- | --- | --- |
| [📄 752六小Giao](ziyuan/752-giao.md) | [📄 AI人工智能导航](ziyuan/ai.md) | [📄 DieHeart](ziyuan/dieheart.md) |
| [📄 HaoRan](ziyuan/haoran.md) | [📄 Python小白](ziyuan/python.md) | [📄 WandY](ziyuan/wandy.md) |
| [📄 ZCC小站](ziyuan/zcc.md) | [📄 admin](ziyuan/admin.md) | [📄 benhappy](ziyuan/benhappy.md) |
| [📄 echsfxy](ziyuan/echsfxy.md) | [📄 wei146134](ziyuan/wei146134.md) | [📄 一枚贝壳](ziyuan/nav12.md) |
| [📄 人间萤火](ziyuan/nav13.md) | [📄 以西](ziyuan/nav14.md) | [📄 伊斯坦堡](ziyuan/nav15.md) |
| [📄 兔兔兔兔兔](ziyuan/nav16.md) | [📄 公子墨](ziyuan/nav17.md) | [📄 公子墨分站——影视](ziyuan/nav18.md) |
| [📄 公子墨分站：办公专用](ziyuan/nav19.md) | [📄 六安工作台](ziyuan/nav20.md) | [📄 助手小伙伴](ziyuan/nav21.md) |
...
- 基于 [docsify](https://docsify.js.org/) 纯静态构建，**零依赖、零构建**，改完即生效。
- 完整项目文档与部署说明见 [GitHub 仓库 README](https://github.com/zhixiaotx/nav-site)。
- 想加新分类？在 `ziyuan/` 下新建一个 md，并在 `_sidebar.md` 加一行链接即可。
